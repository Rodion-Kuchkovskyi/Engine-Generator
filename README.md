...
It automatically generates clean, structured code for a wide range of engine types, including inline, V, boxer, W, radial layouts, and even rotary engines.
...
To start you need to download, then unzip file, and in folder start "Engine Generator".

Most of the usefull information in program, there is help menu. 
